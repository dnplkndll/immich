...
final class Schema23 extends i0.VersionedSchema {
  ...
  late final Shape39 localAlbumAssetEntity = Shape39(
    source: i0.VersionedTable(
      ...
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(asset_id, album_id)'],
      columns: [_column_147, _column_148, _column_146],
      attachedDatabase: database,
    ),
    alias: null,
  );
  ...
  final i1.Index idxLocalAssetRemoteId = i1.Index(
  ...
  late final Shape4 userMetadataEntity = Shape4(
    source: i0.VersionedTable(
      ...
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(user_id, "key")'],
      columns: [_column_154, _column_155, _column_156],
      attachedDatabase: database,
    ),
    alias: null,
  );
  late final Shape41 partnerEntity = Shape41(
    source: i0.VersionedTable(
      ...
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(shared_by_id, shared_with_id)'],
      columns: [_column_157, _column_158, _column_159],
      attachedDatabase: database,
    ),
    alias: null,
  );
  ...
  late final Shape7 remoteAlbumAssetEntity = Shape7(
    source: i0.VersionedTable(
      ...
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(asset_id, album_id)'],
      columns: [_column_160, _column_178],
      attachedDatabase: database,
    ),
    alias: null,
  );
  late final Shape10 remoteAlbumUserEntity = Shape10(
    source: i0.VersionedTable(
      ...
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(album_id, user_id)'],
      columns: [_column_178, _column_154, _column_179],
      attachedDatabase: database,
    ),
    alias: null,
  );
  ...
  late final Shape12 memoryAssetEntity = Shape12(
    source: i0.VersionedTable(
      ...
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(asset_id, memory_id)'],
      columns: [_column_160, _column_188],
      attachedDatabase: database,
    ),
    alias: null,
  );
  ...
  late final Shape18 storeEntity = Shape18(
    source: i0.VersionedTable(
      ...
      isStrict: true,
      tableConstraints: ['PRIMARY KEY(id)'],
      columns: [_column_203, _column_204, _column_205],
      attachedDatabase: database,
    ),
    alias: null,
  );
...
i1.GeneratedColumn<double> _column_137(String aliasedName) =>
    i1.GeneratedColumn<double>(
      'longitude',
      aliasedName,
      true,
...
i1.GeneratedColumn<double> _column_167(String aliasedName) =>
    i1.GeneratedColumn<double>(
      'f_number',
      aliasedName,
      true,
...
i1.GeneratedColumn<i2.Uint8List> _column_209(String aliasedName) =>
    i1.GeneratedColumn<i2.Uint8List>(
      'parameters',
      aliasedName,
      false,
