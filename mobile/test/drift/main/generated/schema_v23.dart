...
class DatabaseAtV23 extends GeneratedDatabase {
  ...
  late final Index idxLocalAssetRemoteId = Index(
    'idx_local_asset_remote_id',
    'CREATE INDEX IF NOT EXISTS idx_local_asset_remote_id ON local_asset_entity (remote_id)',
  );
