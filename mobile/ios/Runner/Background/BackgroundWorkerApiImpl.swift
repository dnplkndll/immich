...
class BackgroundWorkerApiImpl: BackgroundWorkerFgHostApi {
  ...
  private static let refreshTaskID = "\(ForkConfig.bundlePrefix).background.refreshUpload"
  private static let processingTaskID = "\(ForkConfig.bundlePrefix).background.processingUpload"
